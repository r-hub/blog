...
x <- packageDistribution("cholera", c("2020-03-04", "2020-03-07"), memoization = FALSE)
...
```{r packageRank1_code, echo = FALSE}
packageRank(package = "cholera", date = "2020-03-04", size.filter = FALSE, memoization = FALSE)
```
```{r packageRank1, eval = FALSE}
...
```{r packageRank2_code, echo = FALSE}
packageRank(package = "cholera", date = "2020-03-07", size.filter = FALSE, memoization = FALSE)
```
```{r packageRank2, eval = FALSE}
...
dat <- lapply(c("2020-03-04", "2020-03-07"), function(x) {
  packageRank("cholera", date = x, size.filter = FALSE, memoization = FALSE)
})
...
log <- packageLog("cholera", "2020-02-02", memoization = FALSE)
...
log <- packageLog("cholera", "2019-10-22", memoization = FALSE)
