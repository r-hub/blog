...
As written in [Android developer guidance](https://developer.android.com/training/id-auth/identify) and probably every customer service guide ever, _"Everyone likes it when you remember their name."_. Everyone probably likes it too when their barista remembers their usual orders. As an R package developer, what can you do for your R package to remember that?
