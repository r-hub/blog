...
Does your R package work best with some configuration? Does your R package download huge datasets that don't change much on the provider side? Maybe you want to save the corresponding data somewhere persistent so that things will go faster during the next R session. In this blog post we shall explain how an R package developer can go about this.

## User preferences

As written in [Android developer guidance](https://developer.android.com/training/id-auth/identify) and probably every customer service ever, _"Everyone likes it when you remember their name."_. Everyone probably likes it too when their barrista remembers their usual orders. As an R package developer, what can you do for your R package to remember that?
...
other things
* data as package https://journal.r-project.org/archive/2017/RJ-2017-026/index.html
