...
We didn't really discuss [_content_ of vignettes](https://r-pkgs.org/vignettes.html#vignette-advice), how to best assess their usefulness (surveys? traffic data?), or their use as a way to [encapsulate analyses in a package structure](https://annakrystalli.me/rrtools-repro-research/create-compendium.html#create_analysis).
