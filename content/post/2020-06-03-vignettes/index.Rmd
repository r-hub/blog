...
Package vignettes can either use the default Sweave vignette engine, or [a vignette engine provided by a CRAN package](https://cran.r-project.org/doc/manuals/r-release/R-exts.html#Non_002dSweave-vignettes) like [`knitr`](https://bookdown.org/yihui/rmarkdown-cookbook/package-vignette.html).
...
Trouble-shooting advice in the R packages book https://r-pkgs.org/vignettes.html#vignette-cran
