...
A funneled data.frame cannot be materialized by default, it needs a call to a `collect()` function.
By default, duckplyr frames are unfunneled, but duckplyr frames created from Parquet data (presumedly large) are funneled.
