...
```{r, cache=TRUE}
library("future")
bench::mark(no_future <- is.numeric(runif(n = 10000000)))
bench::mark(eager_future <- future(is.numeric(runif(n = 10000000))))
bench::mark(lazy_future <- future(is.numeric(runif(n = 10000000)), lazy = TRUE))
```
