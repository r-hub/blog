...
Therefore, the duckplyr package has a safeguard called **prudence** (in the current development version of the package) to control automatic materialization.
It has three possible settings:

```{r, error=TRUE}
# default: lavish, automatic materialization
mtcars |>
  duckplyr::as_duckdb_tibble() |>
  dplyr::mutate(mpg2 = mpg + 2) |> 
  nrow()

# frugal, no automatic materialization
mtcars |>
