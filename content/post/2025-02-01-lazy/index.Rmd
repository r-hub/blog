...
With futures, you create a future, that is associated to a promise, not the same as the aforementioned base R promise, which is a placeholder for a value and then the value itself.
...
Now, to add confusion beyond the different meaning of "promise" in this context, by default a future is **not lazy**, it is **eager**.
This means that it is computed immediately unless you specify an alternative method (a "plan").
Therefore, the use of futures and the use of lazy evaluation are orthogonal concepts.
