...
percentiles <- vapply(Date, function(x) {
  dat <- packageRank(packages = "cholera", date = x, size.filter = FALSE)
...
```{r cran_pkgs, fig.align = "center", hugoopts = list(title = "Figure 19 Leap Day 2020")}
plot(cranDownloads(from = "2020-02-25", to = "2020-03-04"), r.version = TRUE)
```

```{r cran_r, fig.align = "center", hugoopts = list(title = "Figure 20 Leap Day 2020")}
