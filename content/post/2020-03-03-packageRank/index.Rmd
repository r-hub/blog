...
```{r cranDownloads_viz1, fig.align = "center", hugoopts = list(title = "Figure 1 'HistData' 2019 Package Downloads")}
...
```{r cranDownloads_viz2, fig.align = "center", hugoopts = list(title = "Figure 4 Year-to-Date Downloads for Multiple Packages")}
