...
```
```{r packageDistribution_wed_code, echo = FALSE, fig.align = "center", hugoopts = list(caption = "Figure 6 'cholera' Frequency Distribution with Log(Downloads): Wednesday")}
...
```
```{r packageDistribution_sat_code, echo = FALSE, fig.align = "center", hugoopts = list(caption = "Figure 7 'cholera' Frequency Distribution with Log(Downloads): Saturday")}
