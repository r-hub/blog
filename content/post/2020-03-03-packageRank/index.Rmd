...
```{r motivation, fig.align = "center", hugoopts = list(caption = "Figure 3 'cholera' March 1-7, 2020")}
...
```{r skew, fig.align = "center", hugoopts = list(caption = "Figure 4 'cholera' Nominal Frequency Distribution"), echo = FALSE}
...
```{r packageDistribution, fig.align = "center", hugoopts = list(caption = "Figure 5 'cholera' Frequency Distribution with Log(Downloads)")}
...
```{r packageRank_plot_code, fig.align = "center", hugoopts = list(caption = "Figure 6 'cholera' and the Distribution of Package Downloads, 01 March 2020"), echo = FALSE}
...
```{r counts_ranks, fig.align = "center", hugoopts = list(caption = "Figure 7 Count v. Rank Percentiles March 1-7, 2020"), echo = FALSE}
...
```{r counts_plot, fig.align = "center", hugoopts = list(alt = "alternative text please make it informative", title = "title of the image", caption = "Figure 8 Total CRAN Downloads With and Without ~500 B Entries"), echo = FALSE}
pt1 <- paste0("0", 1:9)
oct.root <- "2019-10-"
...
```{r packages_plot, fig.align = "center", hugoopts = list(caption = "Figure 9 Total Number of Unique Packages Downloaded from CRAN With and Without ~500 B Entries"), echo = FALSE}
pt1 <- paste0("0", 1:9)
oct.root <- "2019-10-"
oct <- as.Date(c(paste0(oct.root, pt1), paste0(oct.root, 10:31)))
id <- which(weekdays(oct, abbreviate = TRUE) == "Wed")
...
```{r versions_plot, fig.align = "center", hugoopts = list(caption = "Figure 10 Percent of Versions Downloaded for 100 Active & 100 Inactive Packages"), echo = FALSE}
...
```{r ggplot2, fig.align = "center", hugoopts = list(caption = "Figure 11 Effect of ~500 B Downloads on Download Counts for a Popular Package"), echo = FALSE}
pkgPlot("ggplot2")
```
...
```{r cholera, fig.align = "center", hugoopts = list(caption = "Figure 12 Effect of ~500 B Downloads on Download Counts for an Unpopular Package"), echo = FALSE}
pkgPlot()
```
...
```{r cholera_version, fig.align = "center", hugoopts = list(caption = "Figure 13 Effect of the Number of Past Versions on Download Counts for a Package with Few Versions"), echo = FALSE}
...
```{r vr_version, fig.align = "center", hugoopts = list(caption = "Figure 14 Effect of the Number of Past Versions on Download Counts for a Package with Many Versions"), echo = FALSE}
...
```{r cholera_size.version, fig.align = "center", hugoopts = list(caption = "Figure 15 Effect of ~500 B Downloads and Number of Past Versions on Download Counts"), echo = FALSE}
...
```{r cran_pkgs, fig.align = "center", hugoopts = list(caption = "Figure 16 Leap Day 2020"), echo = FALSE}
plot(cranDownloads(from = "2020-02-25", to = "2020-03-05"), r.version = TRUE)
```

```{r cran_r, fig.align = "center", hugoopts = list(caption = "Figure 17 Leap Day 2020"), echo = FALSE}
