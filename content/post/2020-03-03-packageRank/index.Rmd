...
```{r cranDownloads_viz1, fig.align = "center", hugoopts = list(title = "Figure 1 Year-to-Date Downloads for a Single package")}
...
```{r cranDownloads_viz2, fig.align = "center", hugoopts = list(title = "Figure 2 Year-to-Date Downloads for Multiple Packages (with 'ggplot2' facets)")}
...
```{r ggplot2, fig.align = "center", hugoopts = list(title = "Figure 14 Effect of ~500 B Downloads on Download Counts on a More Popular Package: October 2019"), echo = FALSE}
pkgPlot("ggplot2")
```
