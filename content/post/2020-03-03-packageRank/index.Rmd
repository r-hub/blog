...
```
```{r log_code, hugoopts = list(title = "Table 1 Download Log: cholera Package February 02, 2020"), echo = FALSE, eval = TRUE}
...
```
```{r log_small_code, hugoopts = list(title = 'Table 2 Examples of "Small" Downloads: cholera Package February 02, 2020'), echo = FALSE}
log <- packageLog("cholera", "2020-02-02")
...
```{r ols_summary, hugoopts = list(title = "Table 3 OLS Regression Table: Bias = Popularity + Versions, October 2019"), echo = FALSE}
summary(ols2)
```
