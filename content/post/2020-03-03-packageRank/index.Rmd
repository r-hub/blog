...
```{r cranDownloads_viz1, fig.align = "center", hugoopts = list(title = "Figure 1 Year-to-Date Downloads for 'HistData' package")}
...
```{r cranDownloads_viz2, fig.align = "center", hugoopts = list(title = "Figure 2 Year-to-Date Downloads for Multiple Packages Using 'ggplot2' facets")}
...
```{r motivation_code, echo = FALSE, fig.align = "center", hugoopts = list(title = "Figure 3 Downloads for 'cholera' package for March 1-7, 2020")}
...
```{r skew_wed, fig.align = "center", hugoopts = list(title = "Figure 4 Frequency Distribution of Package Downloads for March 4, 2020 (Wednesday)"), echo = FALSE}
...
```{r skew_sat, fig.align = "center", hugoopts = list(title = "Figure 5 Frequency Distribution of Package Downloads for March 7, 2020 (Saturday)"), echo = FALSE}
...
```
```{r packageDistribution_wed_code, echo = FALSE, fig.align = "center", hugoopts = list(title = "Figure 6 Frequency Distribution of Package Downloads for March 4, 2020 (Wednesday) with Base 10 Logarithm of Download Counts")}
...
```
```{r packageDistribution_sat_code, echo = FALSE, fig.align = "center", hugoopts = list(title = "Figure 7 Frequency Distribution of Package Downloads for March 7, 2020 (Saturday) with Base 10 Logarithm of Download Counts")}
...
```{r packageRank_plot_code_wed, echo = FALSE, fig.align = "center", hugoopts = list(title = "Figure 8 Rank Frequency Distribution of Package Downloads, March 4, 2020")}
...
```{r packageRank_plot_code_sat, echo = FALSE, fig.align = "center", hugoopts = list(title = "Figure 9 Rank Frequency Distribution of Package Downloads, March 7, 2020")}
...
```{r counts_ranks, fig.align = "center", hugoopts = list(title = "Figure 10 A Comparison of Package Download Counts and Rank Percentiles"), echo = FALSE}
...
```{r counts_plot, fig.align = "center", hugoopts = list(title = "Figure 11 Total Package Downloads from CRAN With and Without ~500 B Entries: October 2019"), echo = FALSE}
...
```{r packages_plot, fig.align = "center", hugoopts = list(title = "Figure 12 Total Number of Unique Packages Downloaded from CRAN With and Without ~500 B Entries: October 2019"), echo = FALSE}
...
```{r ggplot2, fig.align = "center", hugoopts = list(title = "Figure 14 Effect of ~500 B Downloads on Download Counts for a More Popular Package: October 2019"), echo = FALSE}
pkgPlot("ggplot2")
```
...
```{r cholera, fig.align = "center", hugoopts = list(title = "Figure 15 Effect of ~500 B Downloads on Download Counts for a Less Popular Package: October 2019"), echo = FALSE}
pkgPlot()
```
...
```{r cran_pkgs, fig.align = "center", hugoopts = list(title = "Figure 19 Leap Day 2020"), echo = FALSE}
plot(cranDownloads(from = "2020-02-25", to = "2020-03-04"), r.version = TRUE)
```

```{r cran_r, fig.align = "center", hugoopts = list(title = "Figure 20 Leap Day 2020"), echo = FALSE}
