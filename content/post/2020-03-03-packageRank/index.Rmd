...
```{r cranDownloads_viz1, fig.align = "center", hugoopts = list(alt = "Figure 1 Visualize cranDownloads() for A Single Package")}
...
```{r cranDownloads_viz2, fig.align = "center", hugoopts = list(alt = "Figure 2 Visualize cranDownloads() for Multiple Packages")}
...
plot(cranDownloads(packages = "cholera", from = "2020-03-01",
  to = "2020-03-07"))
```
```{r motivation_code, echo = FALSE, fig.align = "center", hugoopts = list(alt = "Figure 3 Package Downloads for 'cholera' March 1-7, 2020")}
...
```{r skew_wed, fig.align = "center", hugoopts = list(alt = "Figure 4 Frequency Distribution of Package Downloads for Wednesday, March 4, 2020"), echo = FALSE}
...
```{r skew_sat, fig.align = "center", hugoopts = list(alt = "Figure 5 Frequency Distribution of Package Downloads for Saturday, March 7, 2020"), echo = FALSE}
...
```
```{r packageDistribution_wed_code, echo = FALSE, fig.align = "center", hugoopts = list(alt = "Figure 6 Frequency Distribution of Package Downloads for Wednesday, March 4, 2020 with Logarithm of Download Counts")}
...
```
```{r packageDistribution_sat_code, echo = FALSE, fig.align = "center", hugoopts = list(alt = "Figure 7 Frequency Distribution of Package Downloads for Saturday, March 7, 2020 with Logarithm of Download Counts")}
...
```{r packageRank_plot_code_wed, echo = FALSE, fig.align = "center", hugoopts = list(alt = "Figure 8 Rank Frequency Distribution of Package Downloads for Wednesday, March 4, 2020")}
...
```{r packageRank_plot_code_sat, echo = FALSE, fig.align = "center", hugoopts = list(alt = "Figure 9 Rank Frequency Distribution of Package Downloads for Saturday, March 7, 2020")}
...
```{r counts_ranks, fig.align = "center", hugoopts = list(alt = "Figure 10 Comparison of Package Download Counts and Rank Percentiles"), echo = FALSE}
...
```
```{r log_code, hugoopts = list(alt = "Table 1 Download Log: cholera Package February 02, 2020"), echo = FALSE, eval = TRUE}
...
```
```{r log_small_code, hugoopts = list(alt = 'Table 2 Examples of "Small" Downloads: cholera Package February 02, 2020'), echo = FALSE}
log <- packageLog("cholera", "2020-02-02")
...
```{r counts_plot, fig.align = "center", hugoopts = list(alt = "Figure 11 Total Package Downloads from CRAN With and Without ~500 B Downloads: October 2019"), echo = FALSE}
...
```{r packages_plot, fig.align = "center", hugoopts = list(alt = "Figure 12 Total Number of Unique Packages Downloaded from CRAN With and Without ~500 B Downloads: October 2019"), echo = FALSE}
...
```{r versions_plot, fig.align = "center", hugoopts = list(alt = "Figure 13 Percent of Package-Versions Downloaded for 100 Active & 100 Inactive Packages: October 2019"), echo = FALSE}
...
```{r ggplot2, fig.align = "center", hugoopts = list(alt = "Figure 14 Effect of ~500 B Downloads on Download Counts on a Popular Package: October 2019"), echo = FALSE}
pkgPlot("ggplot2")
```
...
```{r cholera, fig.align = "center", hugoopts = list(alt = "Figure 15 Effect of ~500 B Downloads on Download Counts on a Less Popular Package: October 2019"), echo = FALSE}
pkgPlot()
```
...
```{r cholera_version, fig.align = "center", hugoopts = list(alt = "Figure 16 Effect of the Number of Prior Versions on Download Counts for a Package with Few Versions: October 2019"), echo = FALSE}
...
```{r vr_version, fig.align = "center", hugoopts = list(alt = "Figure 17 Effect of the Number of Past Versions on Download Counts for a Package with Many Versions: October 2019"), echo = FALSE}
...
```{r cholera_size.version, fig.align = "center", hugoopts = list(alt = "Figure 18 Effect of ~500 B Downloads and Number of Past Versions on Download Counts: October 2019"), echo = FALSE}
...
```{r ols_summary, hugoopts = list(alt = "Table 3 OLS Regression Table: Bias = Popularity + Versions, October 2019"), echo = FALSE}
summary(ols2)
```
...
```{r cran_pkgs, fig.align = "center", hugoopts = list(alt = "Figure 19 Effect of the 2020 Leap Day on Package Downloads")}
...
```{r cran_r, fig.align = "center", hugoopts = list(alt = "Figure 20 Effect of 2020 Leap Day on R Downloads")}
