...
```r
cranDownloads(packages = "cholera", from = "2019-02", to = "2019-02") # 28 obs.
cranDownloads(packages = "cholera", from = "2020-02", to = "2020-02") # 29 obs.
```
...
{{<figure src="motivation-1.png" caption="Figure 3 'cholera' March 1-7, 2020">}}
...
{{<figure src="skew-1.png" caption="Figure 4 'cholera' Nominal Frequency Distribution">}}
{{<figure src="skew-2.png" caption="Figure 4 'cholera' Nominal Frequency Distribution">}}

The left side of the distribution, where packages with fewer downloads are located, _looks_ like a vertical line. This is because, using Wednesday as an example, the most downloaded package had 177,745 downloads while the least downloaded package had just 1. To help see what's going on, I redraw the plots taking the logarithm of download counts (x-axis). In these plots, each vertical segment represents an observed download count and the height of a segment represents the number of packages with that download count:
...
plot(packageDistribution(package = "cholera", date = c("2020-03-04", "2020-03-07")))
```

{{<figure src="packageDistribution-1.png" caption="Figure 5 'cholera' Frequency Distribution with Log(Downloads)">}}
{{<figure src="packageDistribution-2.png" caption="Figure 5 'cholera' Frequency Distribution with Log(Downloads)">}}

While this give us a better picture of where 'cholera' is located, comparisons between Wednesday and Saturday are impressionistic at best: all we can confidently say is that the download counts on both days were above than the mode.
...
{{<figure src="packageRank_plot_code-1.png" caption="Figure 6 'cholera' and the Distribution of Package Downloads, 01 March 2020">}}
{{<figure src="packageRank_plot_code-2.png" caption="Figure 6 'cholera' and the Distribution of Package Downloads, 01 March 2020">}}
...
{{<figure src="counts_ranks-1.png" caption="Figure 7 Count v. Rank Percentiles March 1-7, 2020">}}
...
{{<figure src="counts_plot-1.png" alt="alternative text please make it informative" title="title of the image" caption="Figure 8 Total CRAN Downloads With and Without ~500 B Entries">}}
...
{{<figure src="packages_plot-1.png" caption="Figure 9 Total Number of Unique Packages Downloaded from CRAN With and Without ~500 B Entries">}}
...
{{<figure src="versions_plot-1.png" caption="Figure 10 Percent of Versions Downloaded for 100 Active & 100 Inactive Packages">}}
...
{{<figure src="ggplot2-1.png" caption="Figure 11 Effect of ~500 B Downloads on Download Counts for a Popular Package">}}
...
{{<figure src="cholera-1.png" caption="Figure 12 Effect of ~500 B Downloads on Download Counts for an Unpopular Package">}}
...
{{<figure src="cholera_version-1.png" caption="Figure 13 Effect of the Number of Past Versions on Download Counts for a Package with Few Versions">}}
...
{{<figure src="vr_version-1.png" caption="Figure 14 Effect of the Number of Past Versions on Download Counts for a Package with Many Versions">}}
...
{{<figure src="cholera_size.version-1.png" caption="Figure 15 Effect of ~500 B Downloads and Number of Past Versions on Download Counts">}}
...
{{<figure src="cran_pkgs-1.png" caption="Figure 16 Leap Day 2020">}}

{{<figure src="cran_r-1.png" caption="Figure 17 Leap Day 2020">}}
