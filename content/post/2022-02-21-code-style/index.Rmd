...
What *is* a standard good approach is having a team/company style guide.Major Tech Companies have style guides, e.g.
...
It is pretty common to find *linting tools* all editor (VSCODE and others) and for most languages.
...
-   The [styler R package](https://styler.r-lib.org) also automatically reformats code.
