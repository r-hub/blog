...
This happens when packages rely on external software, such as how [R packages integrating CUDA GPU computation in R](https://en.wikipedia.org/wiki/CUDA) require the [CUDA library](https://en.wikipedia.org/wiki/CUDA).
...
In particular, we will focus with the integration with [GitHub Actions](https://resources.github.com/devops/tools/automation/actions/).
