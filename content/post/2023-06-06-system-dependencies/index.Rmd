...
-   or submit a pull request to `r-hub/r-system-requirements` if you believe the regular expression is too restrictive and should be updated ([example](https://github.com/rstudio/r-system-requirements/pull/93))
