...
To take a step back, how do such files and directories end up, or not, in the tarball/bundled package, from the source package?
...
* It will copy your whole package source.

* It will then remove files in three "steps"
...
[^git]: But .gitignore and friends need to be explicitely listed in `.Rbuildignore`... Maybe a [patch to R](https://www.r-project.org/bugs.html#how-to-submit-patches) would make sense?