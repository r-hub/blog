...
When to update (remember, Make, etc.)

#### Code generator in a dedicated package

Similar to previous setups https://twitter.com/ijlyttle/status/1199454056638537728?s=20
    
### Generating code at installation

icon https://github.com/ropenscilabs/icon/blob/a5bc1cc928b15a5296b06f66faa9e08264ad4064/R/fa.R#L28-L37 in icons there are two things that happen, the function generation at built time and the documenting that's before then (using @evalRd in particular).  @exportPattern
