...
This seems to be quite in line with noffle's checklist (e.g. having installation instructions). Headers related to the background and to examples might have a title specific to the package, hence there being so few "Examples" headers as compared to "Installation" headers.
