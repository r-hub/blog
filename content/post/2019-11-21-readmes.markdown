...
The number of lines of code of READMEs range from 0 (for 28 READMEs) to 41 with a median of 2. The README with the most lines of code is https://github.com/r-lib/ps.
