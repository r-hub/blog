...
(but not `inst/src` or `inst/lib`, these are reserved directory names[^reserved]).
...
as in [this example](https://github.com/gadenbuie/xaringanExtra/blob/master/R/webcam.R) from [xaringanExtra::use_webcam()](https://pkg.garrickadenbuie.com/xaringanExtra/#/?id=webcam).
...
[^reserved]: Refer to the R packages book by Hadley Wickham and Jenny Bryan [for a full list of reserved directory names](https://r-pkgs.org/inst.html).
